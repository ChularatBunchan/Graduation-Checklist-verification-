...
function Check1() {
  ...
  const titles = [
    ...
    "ทดสอบวัดสมิทธิภาพทางภาษาอังกฤษ (KMUTNB-TEPC)",
    "คะแนนภาษาอังกฤษ",
  ...
  const details = [
    ...
    <>
      นักศึกษาระดับปริญญาตรีจะต้องเข้ารับการทดสอบวัดสมิทธิภาพทางภาษาอังกฤษก่อนสำเร็จการศึกษา
      (English Proficiency Exam/ KMUTNB-TEPC)
      <br />
      ทั้งนี้สามารถนำคะแนนภาษาอังกฤษจากข้อ 4 มายื่นแทนการทดสอบวัดสมิทธิภาพทางภาษาอังกฤษก่อนสำเร็จการศึกษาของมหาวิทยาลัยได้
    </>,
    ...
    <>
       สามารถบันทึกภาพหน้าจอที่หน้าโปรไฟล์ จากเว็บไซต์  
     <Link
        sx={{ marginLeft: 1 }}
        href="https://reg.kmutnb.ac.th/registrar/home"
        underline="hover"
     >
     reg KMUTNB
     </Link>
